...
public final class PasswordServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ie.gmit.ds.ValidatePasswordRequest,
      ie.gmit.ds.ValidatePasswordResponse> getValidateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "validate",
      requestType = ie.gmit.ds.ValidatePasswordRequest.class,
      responseType = ie.gmit.ds.ValidatePasswordResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ie.gmit.ds.ValidatePasswordRequest,
      ie.gmit.ds.ValidatePasswordResponse> getValidateMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.ValidatePasswordRequest, ie.gmit.ds.ValidatePasswordResponse> getValidateMethod;
    if ((getValidateMethod = PasswordServiceGrpc.getValidateMethod) == null) {
      synchronized (PasswordServiceGrpc.class) {
        if ((getValidateMethod = PasswordServiceGrpc.getValidateMethod) == null) {
          PasswordServiceGrpc.getValidateMethod = getValidateMethod =
              io.grpc.MethodDescriptor.<ie.gmit.ds.ValidatePasswordRequest, ie.gmit.ds.ValidatePasswordResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "validate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.ValidatePasswordRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.ValidatePasswordResponse.getDefaultInstance()))
  ...
  public static abstract class PasswordServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void validate(ie.gmit.ds.ValidatePasswordRequest request,
        io.grpc.stub.StreamObserver<ie.gmit.ds.ValidatePasswordResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ie.gmit.ds.ValidatePasswordRequest,
                ie.gmit.ds.ValidatePasswordResponse>(
  ...
  public static final class PasswordServiceBlockingStub extends io.grpc.stub.AbstractStub<PasswordServiceBlockingStub> {
    ...
    /**
     */
    public ie.gmit.ds.ValidatePasswordResponse validate(ie.gmit.ds.ValidatePasswordRequest request) {
      return blockingUnaryCall(
  ...
  public static final class PasswordServiceFutureStub extends io.grpc.stub.AbstractStub<PasswordServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ie.gmit.ds.ValidatePasswordResponse> validate(
        ie.gmit.ds.ValidatePasswordRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_VALIDATE:
          serviceImpl.validate((ie.gmit.ds.ValidatePasswordRequest) request,
              (io.grpc.stub.StreamObserver<ie.gmit.ds.ValidatePasswordResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PasswordServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ie.gmit.ds.User.getDescriptor();
    }
